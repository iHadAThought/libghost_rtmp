...
all: libmedia_core.a libghost_ffmpeg_rx.a libghost_rtmp.a
...
libghost_rtmp.a: src/modules/rtmp/ghost_rtmp.c include/ghost_rtmp.h libghost_ffmpeg_rx.a libmedia_core.a
	$(CC) $(CFLAGS) -c -o ghost_rtmp.o src/modules/rtmp/ghost_rtmp.c && $(AR) rcs $@ ghost_rtmp.o && rm -f ghost_rtmp.o

install: all
	install -d $(DESTDIR)$(PREFIX)/include $(DESTDIR)$(PREFIX)/lib
	install -m 644 include/*.h $(DESTDIR)$(PREFIX)/include/
	install -m 644 libmedia_core.a libghost_ffmpeg_rx.a libghost_rtmp.a $(DESTDIR)$(PREFIX)/lib/
